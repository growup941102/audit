const route: App.I18n.Schema['translation']['route'] = {
  '(base)_about': 'About',
  '(base)_data-fetch': 'Smart Data Fetch',
  '(base)_data-fetch_data-overview': 'Data Overview',
  '(base)_data-fetch_data-query': 'Data Query',
  '(base)_data-fetch_data-schedule': 'Data Schedule',
  ...
  '(base)_project-review_review-rules': 'Review Rules',
  '(base)_project-review_review-schedule': 'Review Schedule',
