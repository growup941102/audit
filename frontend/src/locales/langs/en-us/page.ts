const page: App.I18n.Schema['translation']['page'] = {
  ...
  dataOverview: {
    ...
    taskRankingTitle: 'Task Ranking TOP20',
  ...
  dataSchedule: {
    ...
    creator: 'Creator',
    deleteTodo: 'Delete is not implemented yet',
    detailAction: 'Action',
    detailAll: 'All',
    detailBidNo: 'Bid No.',
    detailClose: 'Close',
    detailComplete: 'Complete',
    detailCreateRow: 'New Row',
    detailCreateRowSuccess: 'Row created',
    detailDataDetail: 'Data Detail',
    detailDeleteRowSuccess: 'Deleted successfully',
    detailDrilldownCreateRowTitle: 'Create Row',
    detailDrilldownEditRowTitle: 'Edit Row',
    detailDrilldownFieldRequired: 'Please enter {{fieldName}}',
    detailDownload: 'Download',
    detailDownloadSuccess: 'Download succeeded',
    detailDownloading: 'Downloading',
    detailEdit: 'Edit',
    detailEditFieldTitle: 'Edit Field: {{fieldName}}',
    detailEditPlaceholder: 'Please enter field value',
    detailEditSaved: 'Field value updated',
    detailFieldDetail: 'Field Detail',
    detailFieldName: 'Field Name',
    detailFieldValue: 'Field Value',
    detailKeyMatchRate: 'Key Field Match Rate',
    detailMissing: 'Missing',
    detailNoData: 'No data',
    detailPreview: 'Preview',
    detailSourceHint: 'Rows can be added or removed',
    detailSave: 'Save',
    detailTaskInfo: 'Task Info',
    detailUpdateRowSuccess: 'Saved successfully',
    detailView: 'View',
    ...
    logCountUnit: 'items',
    logExport: 'Export',
    logExportSuccess: 'Logs exported successfully',
    logFollowLatest: 'Follow Latest',
    logKeywordPlaceholder: 'Search logs',
    logLevel: 'Level',
    logLevelError: 'error',
    logLevelInfo: 'info',
    ...
    logNoData: 'No logs',
    logNodeName: 'Node',
    logProjectName: 'Project Name',
    logServiceName: 'Service Name',
    logTime: 'Time',
    logTitle: 'Data Extract Logs',
    logTotalLabel: 'Total',
    form: {
      creator: 'Please select creator',
      matchRangeMax: 'Please input',
      matchRangeMin: 'Please input',
  ...
  websiteSettings: {
    ...
    form: {
      watermarkText: 'Please enter watermark text',
      websiteName: 'Please enter website name'
    },
    logo: 'Website Logo',
    ...
    watermark: {
      ...
      opacity: 'Opacity',
      rotate: 'Rotate',
      sectionTitle: 'Watermark Settings',
      text: 'Watermark Text'
    },
