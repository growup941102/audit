const page: App.I18n.Schema['translation']['page'] = {
  ...
  dataOverview: {
    ...
    runningRate: '运行占比',
    runningTasks: '正在运行任务数',
    taskRankingTitle: '任务状况排名 TOP20',
    totalTasks: '总任务数',
    viewMoreData: '查看更多数据 >'
  },
  dataSchedule: {
    ...
    detailComplete: '提取完整',
    detailCreateRow: '新增行',
    detailCreateRowSuccess: '新增行成功',
    detailDataDetail: '数据详情',
    detailDeleteRowSuccess: '删除成功',
    detailDrilldownCreateRowTitle: '新增行',
    detailDrilldownEditRowTitle: '编辑行',
    detailDrilldownFieldRequired: '请输入{{fieldName}}',
    detailDownload: '下载',
    detailDownloadSuccess: '下载成功',
    detailDownloading: '下载中',
    detailEdit: '编辑',
    detailEditFieldTitle: '编辑字段：{{fieldName}}',
    detailEditPlaceholder: '请输入字段内容',
    detailEditSaved: '字段内容已更新',
    detailFieldDetail: '字段详情',
    detailFieldName: '字段名称',
    detailFieldValue: '字段内容',
    detailKeyMatchRate: '关键字段匹配程度',
    detailMissing: '提取缺失',
    detailNoData: '暂无数据',
    detailPreview: '预览',
    detailSourceHint: '可新增/删除行',
    detailSave: '保存',
    detailTaskInfo: '任务信息',
    detailUpdateRowSuccess: '保存成功',
    detailView: '查看',
    executionLog: '执行日志',
    logComponent: '组件',
    logCountLabel: '查询条数',
    logCountUnit: '条',
    logExport: '导出',
    logExportSuccess: '日志导出成功',
    logFollowLatest: '跟随最新',
    logKeywordPlaceholder: '搜索日志内容',
    logLevel: '等级',
    logLevelError: 'error',
    logLevelInfo: 'info',
