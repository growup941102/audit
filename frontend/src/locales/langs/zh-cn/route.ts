const route: App.I18n.Schema['translation']['route'] = {
  '(base)_about': '关于',
  '(base)_data-fetch': '智能取数',
  '(base)_data-fetch_data-overview': '数据概览',
  '(base)_data-fetch_data-query': '数据查询',
  '(base)_data-fetch_data-schedule': '数据调度',
  '(base)_function': '系统功能',
  ...
  '(base)_project-review': '项目审查',
  '(base)_project-review_review-rules': '审查规则',
  '(base)_project-review_review-schedule': '审查调度',
  ...
  '(base)_system-settings': '系统设置',
  '(base)_system-settings_user-manage': '用户管理',
  '(base)_system-settings_watermark-settings': '水印设置',
  '(base)_system-settings_website-settings': '网站设置',
