...
"(base)_data-fetch_data-overview": () => import("@/pages/(base)/data-fetch/data-overview/index.tsx"),
"(base)_data-fetch_data-query": () => import("@/pages/(base)/data-fetch/data-query/index.tsx"),
"(base)_data-fetch_data-schedule": () => import("@/pages/(base)/data-fetch/data-schedule/index.tsx"),
"(base)_data-fetch": () => import("@/pages/(base)/data-fetch/index.tsx"),
...
"(base)_project-review": () => import("@/pages/(base)/project-review/index.tsx"),
"(base)_project-review_review-rules": () => import("@/pages/(base)/project-review/review-rules/index.tsx"),
"(base)_project-review_review-schedule": () => import("@/pages/(base)/project-review/review-schedule/index.tsx"),
